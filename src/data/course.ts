...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    no: '05',
    title: '项目实战二 · 约妆小程序',
    subtitle: '演唱会应援妆主题 · 免登录 · 个人主体即可上线',
    icon: 'calendar',
    status: 'updating',
    lessons: [
      { title: '项目初始化与云开发环境搭建', tag: '规划中' },
      { title: '设计预约数据模型（妆造服务 / 档期 / 订单）', tag: '规划中' },
      { title: '妆造服务列表与详情页开发', tag: '规划中' },
      { title: '日历组件与档期选择', tag: '规划中' },
      { title: '预约表单与免登录下单', tag: '规划中' },
      { title: '订阅消息：预约成功通知', tag: '规划中' },
      { title: '我的预约：查询与取消', tag: '规划中' },
      { title: '商家管理端：档期管理', tag: '规划中' },
...
export const projects: Project[] = [
  ...
  },
  {
    no: 'PROJECT 02',
    name: '约妆小程序（演唱会应援妆）',
    desc: '基于微信云开发的档期预约系统：妆造服务展示、日历选档期、免登录下单、订阅消息通知，附带商家管理端（档期与核销）。个人主体即可发布，番外篇讲解定金支付。',
    badges: ['微信云开发', '免登录', '日历选档期', '订阅消息', '商家管理端'],
...
export const faqs: Faq[] = [
  ...
  {
    q: '学完之后能做出什么？',
    a: '两个可以真正发布上线的小程序：一个是接入 DeepSeek API 的 AI 角色聊天小程序（含云函数与 API 文档），一个是基于微信云开发的约妆小程序（日历选档期、免登录、订阅消息、商家管理端）——个人主体就能发布，不需要企业资质。',
  },
  {
    q: '约妆小程序支持在线支付吗？',
    a: '主线课程采用「免登录 + 现场付」模式，个人开发者可直接上线。同时提供番外篇「定金支付」：针对有企业资质的同学，讲解如何给约妆加上在线定金，防止爽约。',
  },
]
